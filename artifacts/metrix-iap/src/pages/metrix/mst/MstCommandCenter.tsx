...
const CHILDREN = [
  ...
  { to: "/app/mst/performance", label: "Performance", Icon: TrendingUp, desc: "Universal vs avatar-specific winners.", lineage: "analysis.performance_by_cell[] · v3_variable_performance[]" },
