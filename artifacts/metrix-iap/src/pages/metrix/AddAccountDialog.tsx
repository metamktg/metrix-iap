        ...
        {step === "choose" && (
          <>
            <DialogHeader>
              ...
              <DialogTitle className="text-body-lg font-semibold">Add Ad Account</DialogTitle>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-body font-semibold text-foreground">Connect Meta Ad Account</div>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-body font-semibold text-foreground">Upload manual reports</div>
                  <p className="text-label text-muted-foreground/85 leading-relaxed mt-0.5">
        ...
        {step === "manual_name" && (
          <>
            <DialogHeader>
              ...
              <DialogTitle className="text-body-lg font-semibold">Name the ad account</DialogTitle>
              <DialogDescription className="text-body text-muted-foreground/80 leading-relaxed">
            ...
            <div className="space-y-3">
              <input
                ...
                maxLength={120}
                className={cn(
                  "w-full h-10 px-3 rounded-md bg-white/[0.03] border text-body text-foreground",
        ...
        {step === "manual_uploads" && created && (
          <>
            <DialogHeader>
              ...
              <DialogTitle className="text-body-lg font-semibold">{created.name} created</DialogTitle>
              <DialogDescription className="text-body text-muted-foreground/80 leading-relaxed">
