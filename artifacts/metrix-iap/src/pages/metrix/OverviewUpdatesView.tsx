          ...
          <div className="space-y-2.5">
            {GUIDE_STEPS.map((s, i) => (
              <div key={s.title} className="flex items-start gap-3 rounded-xl border border-border/40 bg-foreground/[0.02] p-3.5">
                <div className="w-6 h-6 rounded border border-border/40 bg-foreground/[0.03] flex items-center justify-center shrink-0 text-label font-mono text-muted-foreground/75">{i + 1}</div>
