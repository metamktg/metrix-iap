...
import { ModuleHeader, ScopeBanner, ConfidenceBadge, UnconfiguredState, PendingState, readableVariables } from "./shared";
...
export function StrategyView() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 overflow-y-auto">
      ...
      <div className="px-6 py-5 space-y-8 max-w-4xl">
        {/* Message pillars */}
        <div>
          <div className="flex items-center gap-1.5 mb-3">
            <Layers className="w-3.5 h-3.5 text-primary/60" />
            <h2 className="text-[11px] font-mono uppercase tracking-widest text-muted-foreground/40">Message pillars</h2>
          </div>
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-3">
            ...
            <h2 className="text-[11px] font-mono uppercase tracking-widest text-muted-foreground/40">Active hypotheses</h2>
          </div>
