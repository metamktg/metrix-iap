                  ...
                  {shown.map((b) => (
                    ...
                    >
                      <div className="flex items-center justify-between gap-2 mb-2">
                        <span className="inline-flex items-center gap-1 text-label font-semibold uppercase tracking-wide text-muted-foreground/70 border border-border/40 px-1.5 py-0.5 rounded leading-none">
                          <FileText className="w-2.5 h-2.5" /> {b.asset_type}
                        </span>
                        <span className="text-label font-semibold uppercase tracking-wide text-amber-300 border border-amber-400/20 bg-amber-400/10 px-1.5 py-0.5 rounded leading-none">
                      ...
                      <div className="flex items-center gap-1.5 mb-2">
                        ...
                        <span className="text-label text-muted-foreground/70">From pillar</span>
                        <span className="text-label font-medium text-foreground">{pillarOf(b.source_pillar)?.label ?? b.source_pillar}</span>
                      </div>

                      <p className="text-body text-foreground/80 leading-relaxed flex-1">{b.human_direction}</p>

                      <div className="mt-3 pt-3 border-t border-border/20">
                        <div className="text-label-xs font-mono uppercase tracking-widest text-muted-foreground/60 mb-1.5">Creative direction</div>
