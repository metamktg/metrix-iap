        ...
        <div className="relative flex-1 min-w-0 max-w-xs">
          ...
          <input
            ...
            className="w-full h-9 pl-8 pr-8 rounded-lg bg-input/40 text-body text-foreground
                       ...
                       transition-[background-color,box-shadow] duration-150 ease-[var(--ease-out)]
          ...
          {query && (
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 w-10 h-10 grid place-items-center
                         ...
                         transition-[color,scale] duration-150 ease-[var(--ease-out)]"
            >
          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              {visible.map((r) => (
                <tr
                  key={rowKey(r)}
                  className="border-t border-border/40 transition-colors duration-150 ease-[var(--ease-out)] hover:bg-muted/25"
                >
      ...
      {hidden > 0 && (
        <button
          ...
          className="mt-2 h-10 px-3 -ml-3 text-caption text-muted-foreground hover:text-foreground
                     active:scale-[0.96] transition-[color,scale] duration-150 ease-[var(--ease-out)]"
        >
