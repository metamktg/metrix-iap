...
export const DESIGN_SYSTEM = {
  title: 'Command Deck Design System',
  description:
    'A mission-control instrument-panel language: deep space-navy surfaces, signal-blue and cyan readouts, mono terminal labels, and hard-edged panels.',
} as const;
