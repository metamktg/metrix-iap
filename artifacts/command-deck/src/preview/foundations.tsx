      ...
      <section className="space-y-4 rounded-xl border bg-card p-5 text-card-foreground">
        ...
        <Guidelines
          items={[
            {
              kind: 'do',
              text: 'Set section labels, metric readouts, and entity codes in the mono face, uppercase, with wide letter-spacing.',
            },
            {
              kind: 'do',
              text: 'Mark panel status with a thin left accent bar — emerald for healthy/control, amber for warning — instead of filling the panel with color.',
            },
            {
              kind: 'do',
              text: 'Keep surfaces near-square and layered: dark navy panels on a deeper navy background, separated by faint signal-blue borders.',
            },
            {
              kind: 'dont',
              text: 'Use signal blue and cyan as large fills; they are readout and emphasis colors reserved for text, borders, icons, and small indicators.',
            },
            {
              kind: 'dont',
              text: 'Apply glow effects broadly — reserve them for headline metrics and primary titles.',
            },
          ]}
        />
      </section>
