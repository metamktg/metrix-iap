# Migrating web UI to Command Deck Design System

Read `artifacts/command-deck/docs/AGENTS.md` and
`artifacts/command-deck/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/command-deck/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/command-deck/lib/utils`
- `@/hooks/use-toast` → `@workspace/command-deck/hooks/use-toast`
