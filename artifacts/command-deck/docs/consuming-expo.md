# Consuming Command Deck Design System in Expo apps

Read `artifacts/command-deck/docs/AGENTS.md` first. React Native does
...
`artifacts/command-deck/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/command-deck/tokens";
...
```tsx
import { nativeTheme } from "@workspace/command-deck/lib/native-theme";
import { useColors } from "@workspace/command-deck/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/command-deck/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/command-deck/components/native/badge";
import { Button } from "@workspace/command-deck/components/native/button";
import { Card } from "@workspace/command-deck/components/native/card";
```
...
Import and render
`@workspace/command-deck/components/native/button`, then run Expo
