# Consuming Command Deck Design System in web apps

Read `artifacts/command-deck/docs/AGENTS.md` first. This guide covers
...
`artifacts/command-deck/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/command-deck/styles.css";
```
...
`node_modules/@workspace/command-deck/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/command-deck/components/ui/button";
import { cn } from "@workspace/command-deck/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/command-deck/hooks/use-toast";
```
...
`@workspace/command-deck/components/ui/button`. Run the app's typecheck
