...
sidebar was a 56 px rail and a workspace map (change log entry 6 — withdrawn the same day on owner review: entry 7 is the collapsible sidebar whose pages disclose on a 180 ms dwell or focus, purposes as tooltips, inline notes back behind reveals; PR #189, `c85b55c`, live as deployment `329ef7e0` with all 130 assets matching a local build of main); the KPI hover chart is drawn
