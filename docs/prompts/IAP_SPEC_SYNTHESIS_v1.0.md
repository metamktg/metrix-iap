...
(`docs/architecture/IAP_ROADMAP_SPEC_BRIEFS_2026-07.md`) into production-ready
...
INPUT BRIEF: docs/architecture/IAP_ROADMAP_SPEC_BRIEFS_2026-07.md § <item>
AUDIT CONTEXT: docs/architecture/IAP_INFRASTRUCTURE_AUDIT_2026-07.md § <section>
