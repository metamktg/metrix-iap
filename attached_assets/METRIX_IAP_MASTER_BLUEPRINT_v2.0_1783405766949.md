...
- **The resolver's naming-convention-primary / ad\_id-fallback priority (v1.5) stands and is now consistent** — with sprint tracking out of the name, there's no ambiguity left in the ad-level naming structure.  
