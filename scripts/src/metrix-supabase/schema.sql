...
create table if not exists ad_breakdown_performance (
  ...
  account_id text not null references ad_accounts(id),
  manual_analysis_run_id uuid not null references manual_analysis_runs(id) on delete cascade,
  breakdown text not null check (breakdown in ('demographic','placement','asset','demographic_asset','placement_asset')),
...
create table if not exists reconciliation_ledger (
  ...
  ad_name text,
  meta_ad_id text,
  report_class text not null check (report_class in ('demographic','placement','asset','demographic_asset','placement_asset')),
...
create table if not exists variable_segment_performance (
  ...
  variable_family text not null,
  variable_id text not null,
  breakdown text not null check (breakdown in ('all','demographic','placement','asset','demographic_asset','placement_asset')),
  segment jsonb not null default '{}',
